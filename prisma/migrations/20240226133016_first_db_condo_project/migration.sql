...
CREATE TABLE `posts` (
    ...
    `postStatus` BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE `condos` (
    ...
    `disstrict` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Image` ADD CONSTRAINT `Image_roomId_fkey` FOREIGN KEY (`roomId`) REFERENCES `rooms`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
